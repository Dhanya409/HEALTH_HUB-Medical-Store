    ...
    if request.method == 'POST':
        ...
        if product_id and quantity:
            try:
                ...
                if cart_item.quantity <= product.net_quantity:
                    cart_item.save()
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        for item in cart_items:
            ...
            item.product.net_quantity -= item.quantity
            item.product.save()
            item.delete()
...
def order_detail(request, order_id):
    try:
        ...
        # You can customize the error handling behavior here
...
class CreatePurchaseOrderView(View):
    ...
    def post(self, request):
        ...
        return redirect('/admin/app/purchaseorder/')  # Redirect to a success page
